...
//        });
   ...
   public void turn_changer(){
    ...
    public void highlight_detect2(int i,int j,int temp,boolean colmn_or_piece){
        ...
        if(!colmn_or_piece) {
            if (runing_flag) {
                if ((board[x][y].piece_counter() < 2) || (board[x][y].piecelist.getLast().getType() == player2.piecetype)) {
   ...
   public void highlight_detect1(int i,int j,int temp,boolean colmn_or_piece){
       ...
       if(!colmn_or_piece){
               if (runing_flag) {
                   if ((board[x][y].piece_counter() < 2)||(board[x][y].piecelist.getLast().getType() == player1.piecetype)) {
